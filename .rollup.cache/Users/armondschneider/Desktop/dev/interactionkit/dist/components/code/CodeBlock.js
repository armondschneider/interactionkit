...
export default function CodeBlock(_a) {
    ...
    return (_jsxs("div", { className: "relative font-sans text-[10px] ".concat(className), children: [title && (_jsx("div", { className: "flex items-center justify-between rounded-t-lg border border-b-0 border-neutral-200 bg-neutral-100 px-3 py-2 dark:border-neutral-700 dark:bg-neutral-800", children: _jsx("span", { className: "text-[11px] font-medium text-neutral-700 dark:text-neutral-200", children: title }) })), _jsx("div", { className: "absolute right-2 z-10 flex items-center gap-2 ".concat(title ? 'top-10' : 'top-2'), children: _jsxs("button", { type: "button", title: copied ? "Copied" : "Copy code", "aria-label": copied ? "Copied" : "Copy code", className: "inline-flex cursor-pointer items-center gap-2 rounded-md bg-neutral-100 px-1.5 py-1.5 text-neutral-700 ring-0 hover:bg-neutral-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-neutral-300 dark:bg-neutral-800 dark:text-neutral-200 dark:hover:bg-neutral-700 dark:focus-visible:ring-neutral-600", onClick: copy, children: [_jsx(AnimatePresence, { mode: "wait", children: !copied ? (_jsx(motion.span, { initial: { opacity: 0, scale: 0.8, filter: 'blur(4px)' }, animate: { opacity: 1, scale: 1, filter: 'blur(0px)' }, exit: { opacity: 0, scale: 0.8, filter: 'blur(4px)' }, transition: { duration: 0.1, ease: "easeOut" }, className: "inline-flex", children: _jsx(Copy, { size: 14 }) }, "copy")) : (_jsx(motion.span, { initial: { opacity: 0, scale: 0.8, filter: 'blur(4px)' }, animate: { opacity: 1, scale: 1, filter: 'blur(0px)' }, exit: { opacity: 0, scale: 0.8, filter: 'blur(4px)' }, transition: { duration: 0.15, ease: "easeOut" }, className: "inline-flex text-green-600", children: _jsx(Check, { size: 14 }) }, "check")) }), _jsx("span", { className: "sr-only", children: copied ? 'Copied' : 'Copy' })] }) }), _jsx("pre", { className: "overflow-auto border border-neutral-200 p-4 text-neutral-900 [scrollbar-color:rgb(150_150_150_/_0.5)_transparent] [scrollbar-width:thin] [&::-webkit-scrollbar]:h-1.5 [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-neutral-400/50 [&::-webkit-scrollbar-thumb:hover]:bg-neutral-500/60 dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-100 ".concat(title ? 'rounded-b-lg rounded-t-none' : 'rounded-lg'), children: _jsx("code", { className: "block whitespace-pre ".concat(language ? "language-".concat(language) : ""), children: (function () {
                    ...
                    })() }) }), typeof previewLines === 'number' && lines.length > previewLines ? (_jsx("div", { className: "flex justify-end mt-2 px-2", children: _jsx("button", { type: "button", className: "cursor-pointer text-xs text-neutral-600 hover:text-neutral-900 focus:outline-none dark:text-neutral-400 dark:hover:text-neutral-100", onClick: function () { return setExpanded(!expanded); }, children: expanded ? 'Show less' : "Show ".concat(lines.length - previewLines, " more") }) })) : null] }));
}
